...
func (_q *VisitorQuery) QueryChurch() *LocalChurchQuery {
...
func (_q *VisitorQuery) QueryCreatedByUser() *UserQuery {
...
func (_q *VisitorQuery) QueryAttendanceRecords() *AttendanceRecordQuery {
...
func (_q *VisitorQuery) FirstID(ctx context.Context) (id uuid.UUID, err error) {
	var ids []uuid.UUID
...
func (_q *VisitorQuery) FirstIDX(ctx context.Context) uuid.UUID {
...
func (_q *VisitorQuery) OnlyID(ctx context.Context) (id uuid.UUID, err error) {
	var ids []uuid.UUID
...
func (_q *VisitorQuery) OnlyIDX(ctx context.Context) uuid.UUID {
...
func (_q *VisitorQuery) IDs(ctx context.Context) (ids []uuid.UUID, err error) {
...
func (_q *VisitorQuery) IDsX(ctx context.Context) []uuid.UUID {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *VisitorQuery) WithChurch(opts ...func(*LocalChurchQuery)) *VisitorQuery {
	query := (&LocalChurchClient{config: _q.config}).Query()
...
func (_q *VisitorQuery) WithCreatedByUser(opts ...func(*UserQuery)) *VisitorQuery {
	query := (&UserClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *VisitorQuery) WithAttendanceRecords(opts ...func(*AttendanceRecordQuery)) *VisitorQuery {
	query := (&AttendanceRecordClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *VisitorQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Visitor, error) {
	...
	if query := _q.withChurch; query != nil {
		if err := _q.loadChurch(ctx, query, nodes, nil,
			func(n *Visitor, e *LocalChurch) { n.Edges.Church = e }); err != nil {
			return nil, err
		}
	}
	if query := _q.withCreatedByUser; query != nil {
		if err := _q.loadCreatedByUser(ctx, query, nodes, nil,
			func(n *Visitor, e *User) { n.Edges.CreatedByUser = e }); err != nil {
			return nil, err
		}
	}
	if query := _q.withAttendanceRecords; query != nil {
		if err := _q.loadAttendanceRecords(ctx, query, nodes,
			func(n *Visitor) { n.Edges.AttendanceRecords = []*AttendanceRecord{} },
			func(n *Visitor, e *AttendanceRecord) {
...
func (_q *VisitorQuery) loadChurch(ctx context.Context, query *LocalChurchQuery, nodes []*Visitor, init func(*Visitor), assign func(*Visitor, *LocalChurch)) error {
	ids := make([]uuid.UUID, 0, len(nodes))
	nodeids := make(map[uuid.UUID][]*Visitor)
	for i := range nodes {
		fk := nodes[i].ChurchID
...
func (_q *VisitorQuery) loadCreatedByUser(ctx context.Context, query *UserQuery, nodes []*Visitor, init func(*Visitor), assign func(*Visitor, *User)) error {
	ids := make([]uuid.UUID, 0, len(nodes))
	nodeids := make(map[uuid.UUID][]*Visitor)
	for i := range nodes {
...
func (_q *VisitorQuery) loadAttendanceRecords(ctx context.Context, query *AttendanceRecordQuery, nodes []*Visitor, init func(*Visitor), assign func(*Visitor, *AttendanceRecord)) error {
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(attendancerecord.FieldVisitorID)
	}
	query.Where(predicate.AttendanceRecord(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(visitor.AttendanceRecordsColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
	...
	for _, n := range neighbors {
		...
		node, ok := nodeids[fk]
		if !ok {
			return fmt.Errorf(`unexpected referenced foreign-key "visitor_id" returned %v for node %v`, fk, n.ID)
		}
		assign(node, n)
	}
	return nil
...
func (_q *VisitorQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(visitor.Table, visitor.Columns, sqlgraph.NewFieldSpec(visitor.FieldID, field.TypeUUID))
	_spec.From = _q.sql
	...
	if fields := _q.ctx.Fields; len(fields) > 0 {
		...
		if _q.withCreatedByUser != nil {
			_spec.Node.AddColumnOnce(visitor.FieldCreatedBy)
		}
	}
