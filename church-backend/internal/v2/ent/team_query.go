...
func (_q *TeamQuery) QueryBranch() *BranchQuery {
...
func (_q *TeamQuery) WithBranch(opts ...func(*BranchQuery)) *TeamQuery {
	query := (&BranchClient{config: _q.config}).Query()
...
func (_q *TeamQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Team, error) {
	...
	if query := _q.withBranch; query != nil {
		if err := _q.loadBranch(ctx, query, nodes, nil,
			func(n *Team, e *Branch) { n.Edges.Branch = e }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (_q *TeamQuery) loadBranch(ctx context.Context, query *BranchQuery, nodes []*Team, init func(*Team), assign func(*Team, *Branch)) error {
...
func (_q *TeamQuery) querySpec() *sqlgraph.QuerySpec {
	...
	if fields := _q.ctx.Fields; len(fields) > 0 {
		...
		if _q.withBranch != nil {
			_spec.Node.AddColumnOnce(team.FieldBranchID)
		}
	}
