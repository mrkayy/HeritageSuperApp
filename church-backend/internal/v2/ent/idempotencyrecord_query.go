...
func (_q *IdempotencyRecordQuery) FirstID(ctx context.Context) (id uuid.UUID, err error) {
	var ids []uuid.UUID
...
func (_q *IdempotencyRecordQuery) FirstIDX(ctx context.Context) uuid.UUID {
...
func (_q *IdempotencyRecordQuery) OnlyID(ctx context.Context) (id uuid.UUID, err error) {
	var ids []uuid.UUID
...
func (_q *IdempotencyRecordQuery) OnlyIDX(ctx context.Context) uuid.UUID {
...
func (_q *IdempotencyRecordQuery) IDs(ctx context.Context) (ids []uuid.UUID, err error) {
...
func (_q *IdempotencyRecordQuery) IDsX(ctx context.Context) []uuid.UUID {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
//		GroupBy(idempotencyrecord.FieldVersion).
//		Aggregate(ent.Count()).
//		Scan(ctx, &v)
...
//
//	client.IdempotencyRecord.Query().
//		Select(idempotencyrecord.FieldVersion).
//		Scan(ctx, &v)
...
func (_q *IdempotencyRecordQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(idempotencyrecord.Table, idempotencyrecord.Columns, sqlgraph.NewFieldSpec(idempotencyrecord.FieldID, field.TypeUUID))
	_spec.From = _q.sql
