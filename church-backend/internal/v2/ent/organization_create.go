...
func (_c *OrganizationCreate) AddBranchIDs(ids ...uuid.UUID) *OrganizationCreate {
	_c.mutation.AddBranchIDs(ids...)
	return _c
}

// AddBranches adds the "branches" edges to the Branch entity.
func (_c *OrganizationCreate) AddBranches(v ...*Branch) *OrganizationCreate {
...
func (_c *OrganizationCreate) check() error {
	if _, ok := _c.mutation.Version(); !ok {
		return &ValidationError{Name: "version", err: errors.New(`ent: missing required field "Organization.version"`)}
	}
