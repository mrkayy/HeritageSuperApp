...
func (e TeamEdges) BranchOrErr() (*Branch, error) {
	if e.Branch != nil {
		return e.Branch, nil
...
func (*Team) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case team.FieldID, team.FieldOrganizationID, team.FieldBranchID:
...
// QueryBranch queries the "branch" edge of the Team entity.
func (_m *Team) QueryBranch() *BranchQuery {
	return NewTeamClient(_m.config).QueryBranch(_m)
}
