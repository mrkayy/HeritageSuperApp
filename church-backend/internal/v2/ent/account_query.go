...
type AccountQuery struct {
	...
	withAuthMethods    *AuthMethodQuery
...
func (_q *AccountQuery) QueryPerson() *PersonQuery {
...
func (_q *AccountQuery) QueryAuthMethods() *AuthMethodQuery {
...
func (_q *AccountQuery) QueryBaselineGrants() *BaselineGrantQuery {
...
func (_q *AccountQuery) WithPerson(opts ...func(*PersonQuery)) *AccountQuery {
	query := (&PersonClient{config: _q.config}).Query()
...
func (_q *AccountQuery) WithAuthMethods(opts ...func(*AuthMethodQuery)) *AccountQuery {
	query := (&AuthMethodClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *AccountQuery) WithBaselineGrants(opts ...func(*BaselineGrantQuery)) *AccountQuery {
	query := (&BaselineGrantClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *AccountQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Account, error) {
	...
	if query := _q.withPerson; query != nil {
		if err := _q.loadPerson(ctx, query, nodes, nil,
			func(n *Account, e *Person) { n.Edges.Person = e }); err != nil {
			return nil, err
		}
	}
	if query := _q.withAuthMethods; query != nil {
		if err := _q.loadAuthMethods(ctx, query, nodes,
			func(n *Account) { n.Edges.AuthMethods = []*AuthMethod{} },
			func(n *Account, e *AuthMethod) { n.Edges.AuthMethods = append(n.Edges.AuthMethods, e) }); err != nil {
			return nil, err
		}
	}
	...
	if query := _q.withBaselineGrants; query != nil {
		if err := _q.loadBaselineGrants(ctx, query, nodes,
			func(n *Account) { n.Edges.BaselineGrants = []*BaselineGrant{} },
			func(n *Account, e *BaselineGrant) { n.Edges.BaselineGrants = append(n.Edges.BaselineGrants, e) }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (_q *AccountQuery) loadPerson(ctx context.Context, query *PersonQuery, nodes []*Account, init func(*Account), assign func(*Account, *Person)) error {
...
func (_q *AccountQuery) loadAuthMethods(ctx context.Context, query *AuthMethodQuery, nodes []*Account, init func(*Account), assign func(*Account, *AuthMethod)) error {
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(authmethod.FieldAccountID)
	}
	query.Where(predicate.AuthMethod(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(account.AuthMethodsColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
...
func (_q *AccountQuery) loadBaselineGrants(ctx context.Context, query *BaselineGrantQuery, nodes []*Account, init func(*Account), assign func(*Account, *BaselineGrant)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[uuid.UUID]*Account)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(baselinegrant.FieldAccountID)
	}
	query.Where(predicate.BaselineGrant(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(account.BaselineGrantsColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
...
func (_q *AccountQuery) querySpec() *sqlgraph.QuerySpec {
	...
	if fields := _q.ctx.Fields; len(fields) > 0 {
		...
		if _q.withPerson != nil {
			_spec.Node.AddColumnOnce(account.FieldPersonID)
		}
	}
